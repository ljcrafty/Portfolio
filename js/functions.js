...
/**
 * Borrowed from: https://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
 */
...
/**
 * Creates a element with a text node inside
 * @param type - the type of element to create
 * @param text - the text to put in a text node inside the new element
...
function arrow()
{
	...
	if( scrollPt > 30 )
	{
		...
		byId("logo").style.display = "initial";
	}
	else
	{
		byTag( "nav" )[0].className = "";
		byId("logo").style.display = "none";
	}
}
